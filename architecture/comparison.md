...
- Agrupar produtos pelo `codigo_barras`.
- Para cada código de barras, identificar os preços cadastrados em cada um dos `mercado_id`.

### 2. Cálculo da Cesta por Mercado
Para cada Mercado (0 a 3):
- Somar o preço de todos os produtos da lista.
